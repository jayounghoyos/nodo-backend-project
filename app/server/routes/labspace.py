...
async def add_labspace_data(labspace: LabSpaceSchema = Body(...), current_user: dict = Depends(get_current_user)):
...
async def get_labspaces(current_user: dict = Depends(get_current_user)):
...
async def get_labspace_data(id: str, current_user: dict = Depends(get_current_user)):
...
async def update_labspace_data(id: str, req: UpdateLabSpaceModel = Body(...), current_user: dict = Depends(get_current_user)):
...
async def delete_labspace_data(id: str, current_user: dict = Depends(get_current_user)):
